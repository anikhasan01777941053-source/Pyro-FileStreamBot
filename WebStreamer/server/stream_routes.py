async def media_streamer(request, message_id: int):
    ...
    print("Media message:", media_msg)
    print("Detected file_name:", file_properties.file_name)
    print("Detected mime_type:", file_properties.mime_type)
    print("Detected file_size:", file_properties.file_size)
    print("=" * 60)
    ...
    if return_resp.status == 200:
        return_resp.headers["Content-Length"] = str(file_size)
